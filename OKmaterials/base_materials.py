...
def decor(item):
    ...
    currency_amount = float(raw_input("How much of this currency is paid: "))
    print("-----------------")
    hp = float(raw_input("Decors HP: "))
    finish_price = []
    print("-----------------")
    builtitem_amount = int(raw_input("How many different items build with: "))
    for i in range(builtitem_amount):
        print("-----------------")
        food_item = str(raw_input("Build item: "))
        food_item_amount = int(raw_input("How many of these items are used?: "))
        for j in range(food_item_amount):
            decoritem_total.append(item_value[food_item])
    print("-----------------")
    finishitem_amount = int(raw_input("How many different items are needed to finish building: "))
    for n in range(finishitem_amount):
        print("-----------------")
        needed_item = str(raw_input("Item needed to finish: "))
        needed_item_amount = int(raw_input("How many of these items are used?: "))
...
if item in item_value:
    ...
    if is_plant == "Y" or is_plant == "y":
        ...
        if is_animal == "Y" or is_animal == "y":
            ...
            is_decor = str(raw_input("Is the item a decor that needs building? Y/N: "))
